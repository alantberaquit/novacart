...
import CartBadge from '../../features/cart/components/CartBadge.jsx'
      ...
      <div className="mx-auto flex min-h-16 max-w-7xl items-center justify-between gap-4 px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <NavLink
            ...
            className={({ isActive }) =>
              [
                'relative ml-1 inline-flex items-center gap-2 rounded-xl px-3 py-2 text-sm font-semibold transition',
                isActive
